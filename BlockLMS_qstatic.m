...
xlabel('Iteration');
ylim([0 2]);
title('Quasi-static case1 (Block LMS)')
...
title('Quasi-static case1 - adaptive filter factor (Block LMS)')

figure(3)
plot(1:length(data1)/B+1,f(1,:)-f(1,length(f(1,:))));
legend('l=1')
title('Quasi-static case1 - adaptive filter f-f* (Block LMS, l=1)');
%% ========================== data 2==============================%%
...
xlabel('Iteration');
ylim([0 2]);
title('Quasi-static case2 (Block LMS)')
...
legend('l=1','l=2','l=3','l=4','l=5','l=6','l=7');
title('Quasi-static case2 - adaptive filter factor (Block LMS)');

figure(6)
plot(1:length(data1)/B+1,f(1,:)-f(1,length(f(1,:))));
legend('l=1')
title('Quasi-static case2 - adaptive filter f-f* (Block LMS, l=1)');
